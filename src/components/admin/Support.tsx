...
export const TICKETS: Ticket[] = [
  {
    ...
    messages: [
      { id: "m1", by: "customer", author: "Adaeze Okafor", at: "Jun 24, 10:14", body: "I cancelled order ORD-528104 four days ago and was told the ₦1.6m would be back in my wallet within 24h. It's still not there. Please escalate." },
      { id: "m2", by: "agent", author: "Funmi A.", at: "Jun 24, 11:02", body: "Hi Adaeze — I can see the cancellation, looking into the wallet reversal now. I'll come back within the hour." },
      { id: "m3", by: "system", author: "MagnetPay", at: "Jun 25, 09:00", body: "Auto-escalated to Payments L2 — SLA breached." },
  ...
  },
  {
    ...
    messages: [
      { id: "m1", by: "customer", author: "Joy Mensah", at: "Jun 28, 06:30", body: "I'm at tier 2 — how do I unlock tier 3?" },
    ],
  },
  {
    id: "TCK-58188", subject: "Chargeback received — what do I do?", status: "open", priority: "urgent",
    channel: "email", queue: "Payments", assignee: "Funmi A.",
    ...
    messages: [
      ...
      { id: "m2", by: "agent", author: "Funmi A.", at: "Jun 28, 02:14", body: "Sending you the evidence pack template — please attach POD + customer comms + product photos." },
    ],
  },
  {
    id: "TCK-58170", subject: "Cookware arrived broken — handled by dispute team", status: "resolved", priority: "normal",
    ...
    messages: [
      ...
      { id: "m3", by: "system", author: "MagnetPay", at: "Jun 26, 11:00", body: "Dispute resolved — full refund issued." },
    ],
  },
  {
    id: "TCK-58145", subject: "Can't log in — keeps asking for OTP", status: "closed", priority: "low",
    ...
    messages: [
      ...
      { id: "m2", by: "agent", author: "Sade M.", at: "Jun 15, 18:20", body: "Reset MFA — should be working now." },
    ],
  },
  {
    id: "TCK-58133", subject: "Payout batch failed — funds returned", status: "on_hold", priority: "high",
    channel: "email", queue: "Payments", assignee: "Funmi A.",
    ...
    messages: [
      { id: "m1", by: "customer", author: "Xiamen LiteBox", at: "Jun 27, 13:00", body: "Our weekly payout bounced back — bank says account doesn't exist but it hasn't changed." },
    ],
  },
  {
    ...
    messages: [
      { id: "m1", by: "customer", author: "Hangzhou WokWise", at: "Jun 28, 08:15", body: "We want to enable CNY→KES, what does it take?" },
    ],
  },
];
          ...
          <tbody>
            {rows.map((t) => (
              <tr key={t.id} className="border-t hover:bg-black/[0.015] transition" style={{ borderColor: T.border }}>
                <td className="px-4 py-3"><input type="checkbox" onClick={(e) => e.stopPropagation()} onChange={() => demo(`Selected ${t.id}`, "info")} /></td>
                ...
                <td className="px-2 py-3">
                  <button onClick={() => demo(`Actions for ${t.id}`, "info")} className="size-7 grid place-items-center rounded-md hover:bg-black/5">
            ...
            {rows.length === 0 && (
              <tr><td colSpan={9} className="px-4 py-12 text-center text-[12px]" style={{ color: T.muted }}>No tickets match these filters.</td></tr>
            )}
          </tbody>
        </table>
      </div>
      <div className="px-4 py-3 flex items-center justify-between text-[11px]" style={{ color: T.sub, borderTop: `1px solid ${T.border}` }}>
        <span className="tabular-nums">Showing {rows.length} of {TICKETS.length}</span>
...
export const MACROS: Macro[] = [
  ...
  { id: "MAC-004", name: "Chargeback evidence pack", shortcut: "/cb-evidence", scope: "Payments", usage: 84, lastUsed: "30 min ago",
    body: "For chargeback {{cb_id}}, please attach:\n• Proof of delivery (carrier POD)\n• Customer comms transcript\n• Product photos / specs\n• Refund policy acknowledgement\n\nDeadline: {{cb_deadline}}." },
  { id: "MAC-005", name: "Account unlock — OTP reset", shortcut: "/otp-reset", scope: "Account", usage: 318, lastUsed: "44 min ago",
  ...
  { id: "MAC-006", name: "Dispute opened — buyer", shortcut: "/dsp-buyer", scope: "Disputes", usage: 142, lastUsed: "2 hr ago",
...
export const CHATS: ChatThread[] = [
  ...
  },
  {
    ...
    lastMessage: "Tracking is updated — please confirm receipt.", lastAt: "1 hr ago",
    ...
    messages: [
      ...
      { id: "c2", by: "seller", at: "Jun 28, 09:10", body: "Tracking is updated — please confirm receipt." },
    ],
  },
  {
...
export const ANNOUNCEMENTS: Announcement[] = [
  { id: "ANN-2041", title: "Scheduled maintenance — Jul 02 02:00-03:00 WAT", body: "MagnetPay wallet and payout APIs will be briefly unavailable during the maintenance window. Marketplace browsing remains online.", audience: "All users", channels: ["in_app", "email", "push"], status: "scheduled", scheduledFor: "Jul 02, 01:00", reach: 184201, authoredBy: "Funmi A.", ctaLabel: "Read status page", ctaUrl: "/status" },
  { id: "ANN-2038", title: "New corridor: CNY → KES is now live", body: "Sellers in Kenya can now accept CNY payments directly. Sign up your store to enable.", audience: "Sellers", channels: ["in_app", "email"], status: "sent", sentAt: "Jun 26, 09:00", reach: 12042, opens: 7281, clicks: 1844, authoredBy: "Daniel K.", ctaLabel: "Enable corridor", ctaUrl: "/seller/corridors" },
  ...
  { id: "ANN-2030", title: "FX promo: 0% spread on first ₦100k", body: "Limited-time CNY→NGN promo for new wallets.", audience: "Nigeria", channels: ["in_app", "push"], status: "sent", sentAt: "Jun 20, 11:00", reach: 84100, opens: 41922, clicks: 7012, authoredBy: "Funmi A." },
...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  { id: "EM-001", name: "Order confirmed", subject: "Your MagnetPay order {{order_id}} is confirmed", category: "Transactional", lastEdited: "Jun 26", editor: "Funmi A.", active: true,
    preheader: "Thanks for shopping — here's what happens next.", vars: ["customer_name", "order_id", "amount", "eta"],
