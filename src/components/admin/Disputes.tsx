...
export const DISPUTES: Dispute[] = [
  {
    ...
    summary: "Shipment stuck at LOS customs — NCC compliance docs requested but seller has not provided FCC/SONCAP certificates.",
    evidence: [
      ...
      { id: "EV-5", side: "carrier", kind: "tracking", title: "MEX2X8810044NG — held since Jun 24", at: "Jun 27, 02:00", by: "MagnetExpress" },
    ],
  },
  {
  ...
  },
  {
    ...
    summary: "Buyer says Ankara fabric pattern is different colorway than listing — claims listing shows red/gold, received navy/gold.",
    evidence: [
  ...
  },
  {
    ...
    summary: "Buyer claims 12 of 80 chargers fail QC — output voltage unstable. Seller offered 20% partial refund; buyer wants full replacement.",
    evidence: [
  ...
  },
  {
    ...
    summary: "Buyer claimed wrong language variant — investigation showed buyer ordered the variant they received.",
    evidence: [
    ...
    ruling: { decision: "Ruled in favor of seller — order matched buyer's selected variant", amountToBuyer: 0, amountToSeller: 603400, ruledAt: "Jun 24, 14:00", ruledBy: "Daniel K.", rationale: "Order configuration log clearly shows buyer selected the English variant they received. No seller error." },
  },
  {
  ...
  },
  {
    ...
    summary: "Card issuer initiated chargeback (reason: 'product not received') — buyer says they actually received and are disputing fraud on the card.",
    evidence: [
...
export function evidenceKindIcon(k: DisputeEvidence["kind"]): ReactNode {
  const map = { photo: "📷", doc: "📄", video: "🎬", message: "💬", tracking: "📦" };
