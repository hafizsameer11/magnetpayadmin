...
export const AML_CASES: AMLCase[] = [
  { id: "AML-7741", user: "Ngozi Eze",      userId: "USR-09701", country: "NG", amountNGN: 1380000, txnId: "DEP-44112", trigger: "Velocity ΓÇö 4 deposits / 24h",      riskScore: 82, severity: "high",     status: "investigating", assignee: "Tunde A.", opened: "3 hr ago",  ageHours: 3,  notes: 4 },
  ...
  { id: "AML-7735", user: "Mary Wanjiru",   userId: "USR-09410", country: "KE", amountNGN: 681000,  txnId: "DEP-44102", trigger: "M-Pesa funded ΓåÆ CNY corridor",      riskScore: 41, severity: "medium",   status: "investigating", assignee: "Tunde A.", opened: "5 days ago",ageHours: 124,notes: 2 },
...
export const PEPS: PEP[] = [
  { id: "PEP-2210", user: "Hon. Chinedu Okeke",   userId: "USR-10412", country: "NG", category: "Minister",        position: "Special Adviser, Finance",      source: "Dow Jones",      score: 88, status: "pending_edd",  lastReview: "ΓÇö" },
...
export const SARS: SAR[] = [
  ...
  { id: "SAR-1030", filingRef: "ΓÇö",                authority: "NFIU",    subject: "Ibrahim Yusuf",  subjectId: "USR-09221", amountNGN: 603400,  amlCaseId: "AML-7740", status: "draft",        filedBy: "Funke O.", filedAt: "ΓÇö",          daysOpen: 0 },
...
export const RISK_RULES: RiskRule[] = [
  ...
  { id: "RR-102", name: "First withdrawal > Γéª100k",   scope: "withdrawal", condition: "is_first_withdrawal AND amount > 100000 NGN", action: "review",    hits24h: 14,  hits30d: 188,  fpRate: 28, enabled: true,  lastEdited: "1 wk ago",   author: "Tunde A." },
  ...
  { id: "RR-104", name: "Structuring pattern",        scope: "deposit",    condition: "ΓëÑ3 deposits 90-110% of tier cap in 24h",       action: "alert",     hits24h: 2,   hits30d: 18,   fpRate: 4,  enabled: true,  lastEdited: "yesterday",  author: "Funke O." },
  ...
  { id: "RR-106", name: "New device + high-cart",     scope: "checkout",   condition: "new_device AND cart_value > Γéª1M",              action: "challenge", hits24h: 22,  hits30d: 312,  fpRate: 18, enabled: true,  lastEdited: "1 wk ago",   author: "Tunde A." },
...
export const BLOCKLIST: ListEntry[] = [
  { id: "BLK-4401", kind: "card",        value: "BIN 484340 ****",                reason: "Chargeback cluster ΓÇö 6 disputes",          addedBy: "Funke O.", addedAt: "2 days ago", hits: 88 },
  ...
  { id: "BLK-4395", kind: "user",        value: "USR-08410 ┬╖ Bayo Akinbode",      reason: "Confirmed fraud ΓÇö internal investigation",   addedBy: "Funke O.", addedAt: "3 wks ago",  hits: 0 },
  { id: "BLK-4390", kind: "country",     value: "≡ƒç«≡ƒç╖ Iran",                        reason: "Sanctions program",                         addedBy: "system",   addedAt: "ΓÇö",          hits: 14 },
  { id: "BLK-4388", kind: "country",     value: "≡ƒç░≡ƒç╡ North Korea",                 reason: "Sanctions program",                         addedBy: "system",   addedAt: "ΓÇö",          hits: 0 },
  { id: "BLK-4385", kind: "currency",    value: "RUB ┬╖ Russian Ruble",            reason: "Corridor disabled ΓÇö sanctions",             addedBy: "system",   addedAt: "ΓÇö",          hits: 0 },
  { id: "BLK-4380", kind: "email_domain",value: "@mailinator.com",                reason: "Disposable email ΓÇö KYC abuse",              addedBy: "Tunde A.", addedAt: "1 mo ago",   hits: 188, expiresAt: "ΓÇö" },
];

export const ALLOWLIST: ListEntry[] = [
  { id: "ALW-2201", kind: "user",        value: "SLR-2041 ┬╖ Shenzhen TopMax",     reason: "Tier S strategic seller ΓÇö bypass velocity",addedBy: "Funke O.", addedAt: "2 mo ago",   hits: 9821 },
  ...
  { id: "ALW-2192", kind: "email_domain",value: "@magnetpay.ng",                  reason: "Internal staff accounts",                   addedBy: "system",   addedAt: "ΓÇö",          hits: 188400 },
  { id: "ALW-2190", kind: "user",        value: "USR-10241 ┬╖ Adaeze Okafor",      reason: "VIP buyer ΓÇö manual whitelist",              addedBy: "Funke O.", addedAt: "2 wks ago",  hits: 142 },
];
...
export const FRAUD_CASES: FraudCase[] = [
  ...
  { id: "FRC-5518", user: "unknown ┬╖ BIN 484340", userId: "ΓÇö",   country: "NG", typology: "Card testing",     lossNGN: 88400,   recoveredNGN: 0,        status: "open",          severity: "high",     assignee: undefined,   linkedCases: 22,evidence: 4,  opened: "12 hr ago" },
...
export const AUDIT: AuditEvent[] = [
  ...
  { id: "AUD-91040", at: "Jun 28 09:14 UTC", actor: "system",          actorId: "BOT-RR",   role: "System",     action: "Risk rule RR-104 triggered",     category: "policy", target: "DEP-44112",    ip: "ΓÇö",            result: "success" },
  ...
  { id: "AUD-91011", at: "Jun 28 05:44 UTC", actor: "unknown",         actorId: "ΓÇö",        role: "System",     action: "Failed admin login (4x)",        category: "auth",   target: "STF-0008",     ip: "185.220.101.41",result:"denied" },
];
...
export const GDPR: GDPRRequest[] = [
  ...
  { id: "GDR-878", user: "Tolu Bankole",  userId: "USR-10182", country: "NG", type: "deletion",    reason: "Closing account ΓÇö right to erasure",        status: "verified",   receivedAt: "5 days ago", dueAt: "Jul 30",  daysLeft: 29, handler: "Tunde A.", artifacts: 0 },
  { id: "GDR-875", user: "Kwame Asante",  userId: "USR-09812", country: "GH", type: "export",      reason: "Loan application ΓÇö wants statements",       status: "completed",  receivedAt: "2 wks ago", dueAt: "Jul 12",  daysLeft: 0,  handler: "Funke O.", artifacts: 4 },
  ...
  { id: "GDR-868", user: "Ibrahim Yusuf", userId: "USR-09221", country: "NG", type: "deletion",    reason: "Erasure request",                           status: "rejected",   receivedAt: "1 wk ago",  dueAt: "ΓÇö",       daysLeft: 0,  handler: "Funke O.", artifacts: 0 },
  { id: "GDR-864", user: "Femi Adeyemi",  userId: "USR-09584", country: "NG", type: "restriction", reason: "Dispute pending ΓÇö restrict processing",     status: "received",   receivedAt: "yesterday", dueAt: "Aug 01",  daysLeft: 33, handler: undefined,   artifacts: 0 },
];
