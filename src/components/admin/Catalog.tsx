...
export const LISTINGS: Listing[] = [
  ...
  { id: "LST-90418", title: "Ankara Print Cotton Roll (6 yds) — Mixed Lot", sku: "FAB-ANK-6YD-MIX", seller: "Guangzhou Aisha Textiles", sellerId: "SLR-1187", category: "Textiles / Fabrics", brand: "Aisha", priceCNY: 142, priceNGN: 32550, stock: 480, moq: 20, status: "active", image: imgAnkara, updated: "1 hr ago", views30d: 9220, orders30d: 184, rating: 4.5 },
  ...
  { id: "LST-90428", title: "Hair Bundle — 100% Virgin Body Wave 18\" (4pc)", sku: "BTY-HRB-18-BDW", seller: "Qingdao GoldStrand Hair", sellerId: "SLR-2810", category: "Beauty / Hair", brand: "GoldStrand", priceCNY: 612, priceNGN: 140250, stock: 220, moq: 4, status: "active", image: imgHair, updated: "3 hr ago", views30d: 24100, orders30d: 410, rating: 4.8 },
...
export const COLLECTIONS = [
  ...
  { id: "COL-004", name: "Beauty Pro Sellers", listings: 62, active: false, slot: "Draft", ends: "—" },
];
...
export const PROMOTIONS = [
  ...
  { id: "PRM-2026-013", name: "First Order — Importers", type: "Coupon trigger", scope: "All categories", discount: "$10 OFF", uses: 1820, budget: "$25,000", spent: "$18,200", status: "running", ends: "Aug 30" },
  { id: "PRM-2026-012", name: "Free Shipping CN→LAG", type: "Shipping promo", scope: "Air Express", discount: "FREE", uses: 96, budget: "$8,000", spent: "$3,140", status: "paused", ends: "Jul 01" },
  { id: "PRM-2026-011", name: "Spring Hair Bundle", type: "BOGO", scope: "Beauty / Hair", discount: "Buy 3 get 1", uses: 248, budget: "—", spent: "—", status: "ended", ends: "Jun 14" },
];
...
export const BANNERS = [
  { id: "BAN-001", title: "Solar Week — up to 15% OFF", placement: "Home Hero", locale: "NG", status: "live", ctr: "3.42%", impressions: 124000, ends: "Jul 12" },
  ...
  { id: "BAN-003", title: "New: Air Express CN→LOS 5-day", placement: "Category — Electronics", locale: "NG", status: "scheduled", ctr: "—", impressions: 0, ends: "Jul 05" },
  { id: "BAN-004", title: "Hair Bundle Deals", placement: "Mobile Splash", locale: "NG", status: "draft", ctr: "—", impressions: 0, ends: "—" },
];
