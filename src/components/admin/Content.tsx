...
export const CMS_PAGES: CmsPage[] = [
  { id: "p_about", slug: "/about", title: "About MagnetPay", section: "Marketing", status: "Published", locale: ["en", "zh", "ar"], version: "v8.4", updatedAt: "2026-06-24 14:02", updatedBy: "Adaeze N.", views30d: 18420, body: "MagnetPay is the trusted escrow rail for China Γåö Africa tradeΓÇª" },
  { id: "p_faq", slug: "/faq", title: "FAQ", section: "Marketing", status: "Published", locale: ["en", "zh"], version: "v2.1", updatedAt: "2026-06-22 09:11", updatedBy: "Tunde K.", views30d: 9210, body: "Common questions about escrow, payouts and disputesΓÇª" },
  { id: "p_press", slug: "/press", title: "Press kit", section: "Marketing", status: "Published", locale: ["en"], version: "v1.0", updatedAt: "2026-06-12 16:48", updatedBy: "Adaeze N.", views30d: 412, body: "Logos, photography, factsheet, and contact for pressΓÇª" },
  { id: "p_careers", slug: "/careers", title: "Careers", section: "Marketing", status: "Draft", locale: ["en"], version: "v0.3", updatedAt: "2026-06-26 19:30", updatedBy: "Olu A.", views30d: 0, body: "Help build cross-border trade infrastructureΓÇª" },
  { id: "p_pricing", slug: "/pricing", title: "Pricing", section: "Marketing", status: "Scheduled", locale: ["en", "zh"], version: "v3.0", updatedAt: "2026-06-25 08:00", updatedBy: "Wei Z.", views30d: 6802, body: "0.9% on funded escrow + ┬Ñ6 fixed per releaseΓÇª" },
  { id: "p_onb_welcome", slug: "/onboarding/welcome", title: "Onboarding ┬╖ Welcome", section: "Onboarding", status: "Published", locale: ["en", "zh", "ar"], version: "v5.2", updatedAt: "2026-06-20 12:18", updatedBy: "System", views30d: 24011, body: "Welcome to MagnetPay. Let's get your wallet readyΓÇª" },
  { id: "p_inapp_empty_orders", slug: "/inapp/empty/orders", title: "Empty state ┬╖ Orders", section: "In-app", status: "Published", locale: ["en", "zh"], version: "v1.4", updatedAt: "2026-06-18 10:00", updatedBy: "Mei L.", views30d: 31204, body: "No orders yet ΓÇö browse the market to get started." },
  { id: "p_footer_partners", slug: "/footer/partners", title: "Footer ┬╖ Partners", section: "Footer", status: "Published", locale: ["en"], version: "v1.0", updatedAt: "2026-05-30 11:22", updatedBy: "Adaeze N.", views30d: 1245, body: "Banking partners, logistics partners and inspection partnersΓÇª" },
];
...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  { id: "h_fees", slug: "magnetpay-fees", title: "What does MagnetPay charge?", category: "Payments & FX", status: "Published", locale: ["en", "zh"], helpful: 88, views30d: 7210, updatedAt: "2026-06-22 15:42", author: "Wei Z.", body: "0.9% on funded escrow + ┬Ñ6 fixed per release. FX at mid-market + 0.35%." },
  { id: "h_payout_time", slug: "payout-time-ngn", title: "How long do CNY ΓåÆ NGN payouts take?", category: "Payments & FX", status: "Published", locale: ["en"], helpful: 81, views30d: 5402, updatedAt: "2026-06-19 12:01", author: "Tunde K.", body: "Typically 1ΓÇô2 business hours during banking hoursΓÇª" },
  { id: "h_cancel", slug: "cancel-after-funding", title: "Can I cancel an order after funding escrow?", category: "Escrow", status: "Published", locale: ["en", "zh"], helpful: 76, views30d: 3120, updatedAt: "2026-06-18 11:23", author: "Adaeze N.", body: "Yes, before production startsΓÇª" },
  { id: "h_sgs", slug: "sgs-inspection", title: "Is SGS inspection mandatory?", category: "Shipping", status: "Published", locale: ["en", "zh"], helpful: 84, views30d: 2811, updatedAt: "2026-06-12 14:18", author: "Mei L.", body: "Optional but recommended on first orders above ┬Ñ50,000ΓÇª" },
  { id: "h_dispute", slug: "open-a-dispute", title: "How to open a dispute", category: "Disputes", status: "Published", locale: ["en", "zh", "ar"], helpful: 90, views30d: 4220, updatedAt: "2026-06-26 18:42", author: "Olu A.", body: "Open a dispute within 7 days of delivery via the order pageΓÇª" },
  { id: "h_2fa", slug: "enable-2fa", title: "Enable 2-factor authentication", category: "Account", status: "Published", locale: ["en", "zh"], helpful: 95, views30d: 1820, updatedAt: "2026-06-08 10:00", author: "System", body: "Go to Settings ΓåÆ Security and tap Enable 2FAΓÇª" },
  { id: "h_seller_payout", slug: "seller-payout-setup", title: "Setting up your seller payout", category: "Seller", status: "Review", locale: ["en", "zh"], helpful: 0, views30d: 0, updatedAt: "2026-06-27 09:20", author: "Wei Z.", body: "Add your bank account and verify with a test depositΓÇª" },
  { id: "h_draft", slug: "ramadan-hours", title: "Ramadan support hours", category: "Account", status: "Draft", locale: ["en", "ar"], helpful: 0, views30d: 0, updatedAt: "2026-06-27 17:02", author: "Adaeze N.", body: "Adjusted hours during RamadanΓÇª" },
];
...
export const LEGAL_DOCS: LegalDoc[] = [
  {
    ...
    versions: [
      { version: "v8.4", publishedAt: "2026-06-04", author: "Legal ┬╖ Olu A.", summary: "Clarified dispute window from 5 ΓåÆ 7 days; added force-majeure clause for port closures.",
        diffLines: [
          ...
          { sign: " ", text: "" },
          { sign: "+", text: "8.7 Force majeure (added) ΓÇö Port closures, customs holds and currency controls beyond MagnetPay's reasonable control suspend SLA timers." },
        ],
      },
      { version: "v8.3", publishedAt: "2026-03-22", author: "Legal ┬╖ Olu A.", summary: "Added Kenya jurisdiction and CBK references.", diffLines: [] },
      { version: "v8.2", publishedAt: "2026-01-15", author: "Legal ┬╖ Olu A.", summary: "Updated escrow fee schedule to 0.9% + ┬Ñ6 fixed.", diffLines: [] },
    ],
  },
  {
    ...
    versions: [
      { version: "v6.1", publishedAt: "2026-06-04", author: "Legal ┬╖ Olu A.", summary: "Listed new sub-processor (Twilio CN) and updated retention table.",
        diffLines: [
          { sign: " ", text: "Annex A ΓÇö Sub-processors" },
          { sign: "+", text: "Twilio Messaging Ltd. (CN region) ΓÇö SMS OTP delivery" },
        ],
      },
...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: ["Faster CNY ΓåÆ NGN payouts (avg 38 min, down from 1h 12m)", "New escrow milestone: 'B/L received'", "Arabic localization in checkout"],
    items: [
      ...
      { tag: "Improved", text: "Payout engine routes via NIBSS Instant for amounts Γëñ Γéª1,000,000." },
  ...
  },
  {
    ...
    items: [
      ...
      { tag: "New", text: "Inline FX hedging quotes on amounts > ┬Ñ100,000." },
    ],
  },
];
