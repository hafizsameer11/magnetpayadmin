...
export const KPI_OVERVIEW = {
  gmv30d:        { value: "¥42.18M", delta: "+12.4%", tone: "success" as const },
...
export const GMV_BY_CORRIDOR = [
  { k: "Guangzhou → Lagos",   v: 14_280_000 },
  { k: "Yiwu → Nairobi",      v:  8_410_000 },
  { k: "Shenzhen → Accra",    v:  6_120_000 },
  { k: "Shanghai → Lagos",    v:  5_700_000 },
  { k: "Foshan → Mombasa",    v:  4_220_000 },
...
export const FX_VOLUME_PAIR = [
  { k: "CNY → NGN", v: 28_420_000, hedged: 18_900_000 },
  { k: "CNY → KES", v:  7_120_000, hedged:  3_800_000 },
  { k: "CNY → GHS", v:  3_420_000, hedged:  1_900_000 },
  { k: "USD → NGN", v:  2_410_000, hedged:    810_000 },
  { k: "AED → NGN", v:    980_000, hedged:    420_000 },
];
...
export const REPORTS: ReportJob[] = [
  ...
  },
  {
    ...
    owner: "Ops · Adaeze N.",
    description: "Pending KYC/KYB cases bucketed by 0–24h, 24–48h, 48–72h and 72h+ with assigned reviewer.",
    history: [
          ...
          <div key={s.k} className="relative">
            <div className="flex items-center justify-between text-[11.5px] mb-1">
              ...
              <span className="tabular-nums" style={{ color: T.sub, fontFamily: "'JetBrains Mono', monospace" }}>
                ...
                {i > 0 && <> · <span style={{ color: drop > 30 ? T.warn : T.muted }}>−{drop.toFixed(1)}%</span> step drop</>}
              </span>
            </div>
...
// Color a cohort cell from cold → hot
...
// Formatters
export const fmtCny = (n: number) => `¥${(n / 1e6).toFixed(2)}M`;
export const fmtCnyK = (n: number) => `¥${Math.round(n / 1000)}k`;
