...
export const SHIPMENTS: Shipment[] = [
  { id: "SHP-44120", orderId: "ORD-528104", buyer: "Adaeze Okafor", buyerCountry: "NG", seller: "Shenzhen TopMax",
    ...
    legs: [
      ...
      { city: "Doha", country: "QA", at: "Jun 27, 22:08", status: "Transit hub — sorted", type: "transit" },
  ...
  { id: "SHP-44091", orderId: "ORD-528077", buyer: "Kwame Asante", buyerCountry: "GH", seller: "Yiwu PowerLine",
    ...
    legs: [
      ...
      { city: "Accra — Osu", country: "GH", at: "Jun 26, 16:20", status: "Delivered (signed K. ASANTE)", type: "delivery" },
    ] },
  { id: "SHP-44074", orderId: "ORD-528060", buyer: "Ngozi Eze", buyerCountry: "NG", seller: "Qingdao GoldStrand",
    ...
    exception: { reason: "Customs hold — NCC compliance docs missing (SONCAP/FCC)", since: "Jun 24, 14:00", severity: "high" },
    legs: [
      { city: "Qingdao", country: "CN", at: "Jun 14, 10:00", status: "Pickup", type: "origin" },
      { city: "Lagos Apapa", country: "NG", at: "Jun 24, 14:00", status: "Customs hold — NCC compliance", type: "exception" },
    ] },
  ...
  { id: "SHP-44008", orderId: "ORD-527990", buyer: "Ibrahim Yusuf", buyerCountry: "NG", seller: "Foshan IronCraft",
    ...
    exception: { reason: "Buyer refused delivery — wrong variant", since: "Jun 26, 10:00", severity: "low" },
    legs: [
      { city: "Foshan", country: "CN", at: "Jun 20, 11:30", status: "Pickup", type: "origin" },
      { city: "Abuja", country: "NG", at: "Jun 26, 09:30", status: "Delivery attempted — refused", type: "exception" },
  ...
  { id: "SHP-44002", orderId: "ORD-527964", buyer: "Chiamaka Obi", buyerCountry: "NG", seller: "Hangzhou WokWise",
    ...
    exception: { reason: "Items damaged on arrival — 2 cartons crushed", since: "Jun 24, 14:00", severity: "high" },
    legs: [
  ...
  { id: "SHP-43990", orderId: "ORD-527942", buyer: "Joy Mensah", buyerCountry: "GH", seller: "Yiwu PowerLine",
    ...
    legs: [
      { city: "Yiwu", country: "CN", at: "Jun 28, 09:00", status: "Label created — awaiting pickup", type: "origin" },
    ] },
...
export const CARRIERS: CarrierConfig[] = [
  {
    ...
    rateCard: [
      ...
      { lane: "CN → NG", service: "Air Economy", baseNGN: 8000,  perKgNGN: 1800, minKg: 0.5 },
      { lane: "CN → GH", service: "Air Express", baseNGN: 14000, perKgNGN: 2600, minKg: 0.5 },
      { lane: "CN → KE", service: "Air Express", baseNGN: 13500, perKgNGN: 2500, minKg: 0.5 },
    ],
  },
  {
    ...
    credentials: [
      { label: "API Key", value: "mes_live_••••••••4408", masked: true },
      { label: "Account Number", value: "MS-NG-9920" },
    ],
    rateCard: [
      { lane: "CN → NG", service: "Sea LCL", baseNGN: 4000, perKgNGN: 380, minKg: 50 },
      { lane: "CN → NG", service: "Sea FCL (20ft)", baseNGN: 2200000, perKgNGN: 0, minKg: 0 },
      { lane: "CN → GH", service: "Sea LCL", baseNGN: 4400, perKgNGN: 420, minKg: 50 },
    ],
  },
  {
    ...
    credentials: [
      ...
      { label: "API Password", value: "•••••••••••2208", masked: true },
      { label: "Account", value: "DHL-NG-44102239" },
    ],
    rateCard: [
      { lane: "CN → NG", service: "Air Express", baseNGN: 18000, perKgNGN: 3200, minKg: 0.5 },
      { lane: "CN → GH", service: "Air Express", baseNGN: 19500, perKgNGN: 3400, minKg: 0.5 },
      { lane: "CN → KE", service: "Air Express", baseNGN: 17800, perKgNGN: 3100, minKg: 0.5 },
    ],
  },
  {
    ...
    credentials: [
      { label: "API Key", value: "cnp_live_••••••••0411", masked: true },
    ],
    rateCard: [
      { lane: "CN → NG", service: "Sea LCL", baseNGN: 3200, perKgNGN: 320, minKg: 80 },
      { lane: "CN → GH", service: "Sea LCL", baseNGN: 3600, perKgNGN: 360, minKg: 80 },
    ],
  },
  {
    ...
    credentials: [
      ...
      { label: "API Password", value: "•••••••••••8841", masked: true },
    ],
    rateCard: [
      { lane: "CN → KE", service: "Air Economy", baseNGN: 8800, perKgNGN: 1900, minKg: 0.5 },
      { lane: "CN → NG", service: "Air Economy", baseNGN: 9200, perKgNGN: 2000, minKg: 0.5 },
    ],
  },
  {
    ...
    credentials: [
      ...
      { label: "API Key", value: "fx_••••••••2299", masked: true },
    ],
    rateCard: [
      { lane: "CN → NG", service: "Air Express", baseNGN: 19200, perKgNGN: 3400, minKg: 0.5 },
    ],
  },
];
...
export const WAREHOUSES: Warehouse[] = [
  ...
  { id: "WH-GZ1", name: "Guangzhou Sea Freight Hub", type: "consolidation", country: "CN", city: "Guangzhou", address: "Baiyun District, Shihua Rd 102", capacityM3: 6800, usedM3: 4128, pendingInbound: 88, pendingOutbound: 42, staff: 18, manager: "Zhang Mei", hours: "Mon–Sat 07:00–22:00", services: ["Container loading", "Pallet wrapping", "Bonded storage"] },
  { id: "WH-YW1", name: "Yiwu Small Goods Hub", type: "consolidation", country: "CN", city: "Yiwu", address: "Beiyuan St, International Trade City Sec 3", capacityM3: 2200, usedM3: 1480, pendingInbound: 68, pendingOutbound: 22, staff: 12, manager: "Chen Hao", hours: "Mon–Sat 08:00–20:00", services: ["Consolidation", "Small parcel sortation"] },
  ...
  { id: "WH-ABV", name: "Abuja Returns Depot", type: "returns", country: "NG", city: "Abuja", address: "Idu Industrial Area, Block 14", capacityM3: 1200, usedM3: 420, pendingInbound: 18, pendingOutbound: 0, staff: 8, manager: "Aisha Mohammed", hours: "Mon–Fri 08:00–18:00", services: ["Returns inspection", "Refurbishment", "Disposal"] },
...
export const ZONES: ShippingZone[] = [
  ...
  { id: "ZON-CN-CO", name: "China — Coastal Origin", countries: ["CN"], cities: ["Shenzhen", "Guangzhou", "Xiamen", "Shanghai", "Hangzhou"], carriers: ["MagnetExpress Air", "MagnetExpress Sea", "CN-Post Sea", "DHL Express"], baseTransitDays: 0, surchargesPct: 0, active: true, shipmentsLast30d: 4640 },
  { id: "ZON-CN-IN", name: "China — Inland Origin", countries: ["CN"], cities: ["Yiwu", "Qingdao", "Foshan", "Dongguan"], carriers: ["MagnetExpress Air", "CN-Post Sea"], baseTransitDays: 1, surchargesPct: 1.5, active: true, shipmentsLast30d: 1108 },
...
export const PICKUP_POINTS: PickupPoint[] = [
  { id: "PP-LOS-001", name: "Magnet Locker — Lekki Phase 1", city: "Lagos", country: "NG", type: "Locker", hours: "24/7", partner: "MagnetPay", active: true, parcelsLast7d: 188, capacity: 240, currentParcels: 142 },
  { id: "PP-LOS-002", name: "Magnet Locker — Victoria Island", city: "Lagos", country: "NG", type: "Locker", hours: "24/7", partner: "MagnetPay", active: true, parcelsLast7d: 162, capacity: 240, currentParcels: 188 },
  { id: "PP-LOS-003", name: "Shop & Pickup — Ikeja City Mall", city: "Lagos", country: "NG", type: "Partner store", hours: "Mon–Sun 09:00–22:00", partner: "Shoprite", active: true, parcelsLast7d: 88, capacity: 120, currentParcels: 42 },
  { id: "PP-ABV-001", name: "Magnet Locker — Wuse 2", city: "Abuja", country: "NG", type: "Locker", hours: "24/7", partner: "MagnetPay", active: true, parcelsLast7d: 68, capacity: 180, currentParcels: 88 },
  { id: "PP-ABV-002", name: "Pickup Office — Maitama", city: "Abuja", country: "NG", type: "Office", hours: "Mon–Fri 08:00–18:00, Sat 09:00–14:00", partner: "MagnetPay", active: true, parcelsLast7d: 42, capacity: 100, currentParcels: 22 },
  { id: "PP-ACC-001", name: "Magnet Locker — Osu Oxford St", city: "Accra", country: "GH", type: "Locker", hours: "24/7", partner: "MagnetPay", active: true, parcelsLast7d: 88, capacity: 180, currentParcels: 122 },
  { id: "PP-ACC-002", name: "Pickup Office — East Legon", city: "Accra", country: "GH", type: "Office", hours: "Mon–Sat 08:00–19:00", partner: "MagnetPay", active: true, parcelsLast7d: 42, capacity: 80, currentParcels: 32 },
  { id: "PP-NBO-001", name: "Pickup Office — Westlands", city: "Nairobi", country: "KE", type: "Office", hours: "Mon–Sat 08:00–19:00", partner: "MagnetPay", active: true, parcelsLast7d: 62, capacity: 120, currentParcels: 48 },
  { id: "PP-NBO-002", name: "Partner Pickup — Naivas Karen", city: "Nairobi", country: "KE", type: "Partner store", hours: "Mon–Sun 08:00–22:00", partner: "Naivas", active: false, parcelsLast7d: 0, capacity: 60, currentParcels: 0 },
];
...
export const LABEL_JOBS: LabelJob[] = [
  ...
  { id: "LBL-99816", shipmentId: "SHP-44074", carrier: "MagnetExpress Sea", format: "A4 PDF", status: "failed", pages: 12, createdAt: "5 hr ago", by: "System", error: "Customs invoice missing — required for HS 8517.62" },
...
export const HS_CODES: HSCode[] = [
  ...
  { code: "8471.30", description: "Portable digital ADP machines ≤10kg (tablets)", category: "Electronics", dutyPctNG: 5, dutyPctGH: 5, dutyPctKE: 0, vatPct: 7.5, restrictedIn: [], requiresCert: ["NCC type-approval (NG)"], shipmentsLast30d: 88 },
  { code: "8544.42", description: "Electric conductors w/ connectors ≤1000V (cables)", category: "Electronics", dutyPctNG: 15, dutyPctGH: 12.5, dutyPctKE: 10, vatPct: 7.5, restrictedIn: [], requiresCert: ["SONCAP (NG)"], shipmentsLast30d: 412 },
];
