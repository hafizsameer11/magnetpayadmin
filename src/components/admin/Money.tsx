...
export function fmtGHS(n: number) { return "GH₵" + n.toLocaleString("en-US"); }
...
export const WALLETS: Wallet[] = [
  ...
  { userId: "PLT-FEE", user: "MagnetPay Fees",   email: "—",                     country: "NG", type: "platform", status: "active", balances: { NGN: 18420000, USD: 41200, CNY: 88000 }, pendingNGN: 0, escrowNGN: 0,    lifetimeNGN: 0,        lastTx: "just now" },
  { userId: "PLT-ESC", user: "MagnetPay Escrow", email: "—",                     country: "NG", type: "platform", status: "active", balances: { NGN: 412800000, CNY: 1820000 },    pendingNGN: 0,      escrowNGN: 0,       lifetimeNGN: 0,        lastTx: "just now" },
];
...
export const DEPOSITS: MoneyMove[] = [
  ...
  { id: "DEP-44112", kind: "deposit", user: "Ngozi Eze",     userId: "USR-09701", country: "NG", currency: "NGN", amount: 1380000, amountNGN: 1380000,  rail: "Paystack",    method: "USSD · *737#",  status: "review",    riskScore: 68, ref: "ps_3Pq8804AB",  at: "3 hr ago", reason: "Velocity flag — 4 deposits in 24h" },
...
export const WITHDRAWALS: MoneyMove[] = [
  { id: "WDR-22041", kind: "withdrawal", user: "Shenzhen TopMax",  userId: "SLR-2041", country: "CN", currency: "CNY", amount: 88400, amountNGN: 20247000, rail: "Wise",     method: "Wise CN → CNY bank",       status: "pending",  riskScore: 14, ref: "wd_998812",       at: "44 min ago" },
  { id: "WDR-22038", kind: "withdrawal", user: "Qingdao GoldStrand", userId: "SLR-2810", country: "CN", currency: "USD", amount: 14400, amountNGN: 22680000, rail: "Wise",     method: "Wise USD → CN HSBC",       status: "approved", riskScore: 6,  ref: "po_b440289_qgs", at: "5 hr ago" },
  ...
  { id: "WDR-22029", kind: "withdrawal", user: "Adaeze Okafor",    userId: "USR-10241", country: "NG", currency: "NGN", amount: 220000, amountNGN: 220000,  rail: "Paystack", method: "GTBank · 0123****12",       status: "review",   riskScore: 51, ref: "wd_ps_44120",     at: "1 hr ago", reason: "First withdrawal > ₦100k" },
  ...
  { id: "WDR-22020", kind: "withdrawal", user: "Shenzhen TopMax",  userId: "SLR-2041", country: "CN", currency: "CNY", amount: 142000, amountNGN: 32524000, rail: "Wise",     method: "Wise CN → CNY bank",       status: "succeeded",riskScore: 6,  ref: "wd_998801",       at: "1 wk ago" },
];
...
export const CHARGEBACKS: Chargeback[] = [
  { id: "CHB-3041", orderId: "ORD-527990", txnId: "TXN-9020301", user: "Ibrahim Yusuf", userId: "USR-09221", country: "NG", amountNGN: 603400, currency: "NGN", rail: "Stripe",      reasonCode: "10.4", reason: "Fraudulent — card-not-present",       status: "evidence_due", dueAt: "Jul 04",  opened: "2 days ago" },
  ...
  { id: "CHB-3029", orderId: "ORD-527880", txnId: "TXN-9020188", user: "Mary Wanjiru",  userId: "USR-09410", country: "KE", amountNGN: 220000,  currency: "KES", rail: "Stripe",      reasonCode: "10.1", reason: "EMV liability shift",                 status: "won",          dueAt: "—",       opened: "2 wks ago" },
  { id: "CHB-3024", orderId: "ORD-527812", txnId: "TXN-9020130", user: "Chiamaka Obi",  userId: "USR-09080", country: "NG", amountNGN: 88000,   currency: "NGN", rail: "Paystack",    reasonCode: "12.5", reason: "Incorrect amount",                    status: "lost",         dueAt: "—",       opened: "3 wks ago" },
];
...
export const CURRENCIES = [
  { code: "NGN", name: "Nigerian Naira",       symbol: "₦",   decimals: 2, enabled: true,  reserves: 412800000, holders: 18420 },
  { code: "CNY", name: "Chinese Yuan",         symbol: "¥",   decimals: 2, enabled: true,  reserves: 1820000,   holders: 248 },
  { code: "USD", name: "US Dollar",            symbol: "$",   decimals: 2, enabled: true,  reserves: 412000,    holders: 1840 },
  { code: "GHS", name: "Ghanaian Cedi",        symbol: "GH₵", decimals: 2, enabled: true,  reserves: 88000,     holders: 612 },
...
export const CORRIDORS = [
  { id: "COR-NG-CN", from: "NG", to: "CN", pair: "NGN→CNY", enabled: true,  monthlyVolNGN: 4820000000, fee: "2.5% + ₦200", settle: "T+1", note: "Primary marketplace corridor" },
  { id: "COR-GH-CN", from: "GH", to: "CN", pair: "GHS→CNY", enabled: true,  monthlyVolNGN: 412000000,  fee: "2.8% + GH₵5", settle: "T+1", note: "" },
  { id: "COR-KE-CN", from: "KE", to: "CN", pair: "KES→CNY", enabled: true,  monthlyVolNGN: 188000000,  fee: "2.8% + KSh50",settle: "T+2", note: "M-Pesa funded" },
  { id: "COR-NG-NG", from: "NG", to: "NG", pair: "NGN↔NGN", enabled: true,  monthlyVolNGN: 1620000000, fee: "0.5%",        settle: "T+0", note: "Domestic wallet transfers" },
  { id: "COR-NG-US", from: "NG", to: "US", pair: "NGN→USD", enabled: true,  monthlyVolNGN: 88000000,   fee: "3.5% + $2",   settle: "T+2", note: "Limited beta" },
  { id: "COR-ZA-CN", from: "ZA", to: "CN", pair: "ZAR→CNY", enabled: false, monthlyVolNGN: 0,          fee: "—",           settle: "—",   note: "Planned Q3 2026" },
];

export const TIER_LIMITS = [
  { tier: "Tier 0 — Unverified", depositDay: 50000,    depositMonth: 250000,    withdrawDay: 0,        withdrawMonth: 0,        singleTxn: 50000,    cur: "NGN" },
  { tier: "Tier 1 — Email/Phone", depositDay: 500000,   depositMonth: 5000000,   withdrawDay: 100000,   withdrawMonth: 1000000,  singleTxn: 200000,   cur: "NGN" },
  { tier: "Tier 2 — KYC light",   depositDay: 5000000,  depositMonth: 50000000,  withdrawDay: 2000000,  withdrawMonth: 20000000, singleTxn: 2000000,  cur: "NGN" },
  { tier: "Tier 3 — KYC full",    depositDay: 25000000, depositMonth: 250000000, withdrawDay: 10000000, withdrawMonth: 100000000,singleTxn: 10000000, cur: "NGN" },
  { tier: "Tier S — Seller (KYB)",depositDay: 100000000,depositMonth: 1000000000,withdrawDay: 50000000, withdrawMonth: 500000000,singleTxn: 50000000, cur: "NGN" },
];

export const FEE_SCHEDULE = [
  { scope: "Marketplace order", corridor: "NGN→CNY", taker: "2.5%", maker: "0%",   floor: "₦200",  cap: "₦25,000", appliesTo: "Buyer" },
  { scope: "Marketplace order", corridor: "GHS→CNY", taker: "2.8%", maker: "0%",   floor: "GH₵5",  cap: "GH₵400",  appliesTo: "Buyer" },
  { scope: "Marketplace order", corridor: "KES→CNY", taker: "2.8%", maker: "0%",   floor: "KSh50", cap: "KSh3000", appliesTo: "Buyer" },
  { scope: "Wallet deposit",    corridor: "NGN",      taker: "1.0%", maker: "1.0%", floor: "₦50",   cap: "₦1,500",  appliesTo: "Funder" },
  { scope: "Wallet withdrawal", corridor: "NGN",      taker: "₦100", maker: "₦100", floor: "—",     cap: "—",        appliesTo: "Holder" },
  { scope: "Seller payout",     corridor: "CNY",      taker: "0.5%", maker: "0.5%", floor: "¥10",   cap: "¥500",     appliesTo: "Seller" },
  { scope: "FX conversion",     corridor: "CNY/NGN",  taker: "1.8%", maker: "1.2%", floor: "—",     cap: "—",        appliesTo: "Spread" },
  { scope: "Chargeback fee",    corridor: "—",        taker: "₦4,500", maker: "₦4,500", floor: "—", cap: "—",        appliesTo: "Seller (on loss)" },
];
...
export const LIQUIDITY = [
  ...
  { provider: "Alipay Merchant", balances: { CNY: 412000, USD: 0,      NGN: 0 },         status: "healthy", utilization: 38, capDaily: "¥3M",   lastSync: "8 min ago" },
  { provider: "OTC Desk (Lagos)",balances: { NGN: 88400000, USD: 88000, GHS: 142000 },   status: "low",     utilization: 91, capDaily: "₦200M", lastSync: "22 min ago" },
  { provider: "MagnetPay Internal",balances: { NGN: 412800000, CNY: 1820000, USD: 412000 }, status: "healthy", utilization: 24, capDaily: "—",   lastSync: "just now" },
];

// Payouts batches
export const PAYOUT_BATCHES = [
  { id: "PYB-30418", cycle: "Daily — Jun 28",  count: 142, totalNGN: 188400000, currency: "CNY", rail: "Wise",   status: "scheduled", runAt: "Today 18:00 UTC" },
  { id: "PYB-30417", cycle: "Daily — Jun 27",  count: 156, totalNGN: 212800000, currency: "CNY", rail: "Wise",   status: "completed", runAt: "Yesterday" },
  { id: "PYB-30416", cycle: "Daily — Jun 26",  count: 138, totalNGN: 188100000, currency: "CNY", rail: "Wise",   status: "completed", runAt: "2 days ago" },
  { id: "PYB-30415", cycle: "Weekly — GHS",    count: 22,  totalNGN: 28400000,  currency: "GHS", rail: "OTC",    status: "completed", runAt: "Monday" },
  { id: "PYB-30414", cycle: "Daily — Jun 25",  count: 8,   totalNGN: 12400000,  currency: "USD", rail: "Wise",   status: "failed",    runAt: "3 days ago" },
];
...
export const LEDGER = [
  ...
  { id: "JE-822038", at: "Jun 28 09:17 UTC", memo: "FX conversion NGN → CNY @ 229.04",        ref: "FXO-44210", lines: [
