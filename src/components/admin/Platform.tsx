...
// ===== Mocks =====
/** Placeholder only ΓÇö real webhook secrets live in server env, never in source. */
const MOCK_SIGNING_SECRET = "ΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇóΓÇó";

export const WEBHOOKS: WebhookEndpoint[] = [
  {
    id: "wh_01HX9",
    url: "https://hooks.alibaba-ng.com/magnetpay/orders",
    description: "Order lifecycle ΓåÆ Alibaba seller dashboard",
  ...
  },
  {
    ...
    description: "Escrow state machine ΓåÆ internal ledger",
  ...
  },
  {
    ...
    description: "Shipment updates ΓåÆ Heshunda freight tracker",
  ...
  },
  {
    ...
    description: "Dispute lifecycle ΓåÆ ops Slack bridge",
...
export const API_KEYS: ApiKey[] = [
  { id: "k_1", name: "Production ┬╖ Ledger writer", prefix: "mp_live_7f2cΓÇª",  scope: "read-write", env: "live", createdBy: "ada.lin@magnetpay.com",   createdAt: "2025-04-08", lastUsed: "12s ago",  status: "active" },
  { id: "k_2", name: "Production ┬╖ Reporting (read)", prefix: "mp_live_3a8fΓÇª",  scope: "read",       env: "live", createdBy: "analytics-bot",            createdAt: "2025-05-22", lastUsed: "2m ago",   status: "active" },
  { id: "k_3", name: "Sandbox ┬╖ Mobile QA",          prefix: "mp_test_1b9dΓÇª",  scope: "read-write", env: "test", createdBy: "qa@magnetpay.com",         createdAt: "2025-09-03", lastUsed: "1h ago",   status: "active" },
  { id: "k_4", name: "Sandbox ┬╖ Carrier integration",prefix: "mp_test_6e4aΓÇª",  scope: "read-write", env: "test", createdBy: "ops.tunde@magnetpay.com",  createdAt: "2025-10-19", lastUsed: "4h ago",   status: "active" },
  { id: "k_5", name: "Legacy ┬╖ Internal admin",     prefix: "mp_live_9c1eΓÇª",  scope: "admin",      env: "live", createdBy: "founders",                 createdAt: "2024-11-30", lastUsed: "2d ago",   status: "revoked" },
];
...
export const JOBS: Job[] = [
  ...
  { id: "job_9d2a6e", name: "shipment.tracking.poll",   queue: "logistics",   status: "retrying",   priority: "normal",   attempts: 2, maxAttempts: 5, enqueuedAt: "13:58:33", startedAt: "13:59:04", payload: { carrier: "heshunda", shipmentId: "shp_OPQ821" }, error: "Upstream 504 ΓÇö retry in 30s" },
  ...
  { id: "job_6a3c9d", name: "ledger.reconcile",         queue: "settlement",  status: "failed",     priority: "high",     attempts: 5, maxAttempts: 5, durationMs: 8104, enqueuedAt: "13:55:11", startedAt: "13:55:12", finishedAt: "13:55:20", payload: { day: "2026-06-27" }, error: "BalanceMismatch: expected Γéª14,238,019.42 actual Γéª14,238,012.07 (╬ö 7.35)" },
...
export const INCIDENTS: Incident[] = [
  {
    ...
    timeline: [
      ...
      { at: "13:17", author: "Tunde O.",  note: "Acknowledged. Investigating upstream ΓÇö Heshunda status page green but error pattern is 504." },
  ...
  {
    id: "INC-2026-0141",
    title: "FX rate snapshot stale ΓÇö CNY/NGN",
    severity: "SEV3",
    status: "resolved",
    ...
    commander: "Folake A.",
    summary: "Provider (CurrencyLayer) returned cached payload for 38 minutes ΓÇö checkout briefly priced using stale 229.18 vs. live 229.04 (╬ö 6 bps).",
    timeline: [],
    postmortem: "Root cause: provider failover did not trigger because health check accepted 200 + cached body. Action items: add freshness assertion (timestamp Γëñ 90s) before accepting rate; add Wise as tertiary fallback. Owner: fx-desk ┬╖ Due: 2026-07-04.",
  },
  {
    id: "INC-2026-0140",
...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: "i_12", name: "Wise (FX backup)", category: "FX",        vendor: "Wise",            status: "disconnected", env: "live",    health: 0,    configuredAt: "ΓÇö" },
